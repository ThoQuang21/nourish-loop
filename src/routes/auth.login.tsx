    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          Chào mừng trở lại với Food Life 🌱
        </p>
      </div>

      {/* Role selector */}
      <div>
        <div className="text-sm font-semibold mb-2">Bạn đăng nhập với tư cách?</div>
      ...
      >
        <div className="space-y-1.5">
          ...
          <input
            ...
            placeholder={
              role === "provider"
                ? "minhanh@lotussaigon.vn"
                : "bepantinhthuong@ngo.vn"
            }
        ...
        >
          <svg className="size-5" viewBox="0 0 48 48">
            <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3c-1.6 4.7-6.1 8-11.3 8-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.8 1.2 7.9 3.1l5.7-5.7C34.5 6.1 29.5 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.3-.4-3.5z" />
            <path fill="#FF3D00" d="m6.3 14.7 6.6 4.8C14.7 16 19 13 24 13c3.1 0 5.8 1.2 7.9 3.1l5.7-5.7C34.5 6.1 29.5 4 24 4 16.3 4 9.7 8.3 6.3 14.7z" />
            <path fill="#4CAF50" d="M24 44c5.4 0 10.3-2 14-5.4l-6.5-5.5c-2 1.4-4.7 2.4-7.5 2.4-5.2 0-9.6-3.3-11.3-8l-6.5 5C9.5 39.6 16.2 44 24 44z" />
            <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.2 5.7l6.5 5.5c-.5.5 7-5 7-15.2 0-1.2-.1-2.3-.4-3.5z" />
          </svg>
          Tiếp tục với Google
        </button>
      </form>
